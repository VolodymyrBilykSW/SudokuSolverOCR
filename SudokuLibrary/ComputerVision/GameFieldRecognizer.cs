...
namespace SudokuLibrary.ComputerVision
{
    public class GameFieldRecognizer
    {
        ...
        public static Image<Bgr, byte> CutField(Image<Bgr, Byte> photo, PointF[] field)
        {
        ...
        public static Image<Bgr, Byte> TestRecognize(Bitmap bmp)
        {
            // Max size for input image, if it`s more then resize image
            int MAXSIZE = Properties.Settings.Default.MAXSIZE; //2000;
        ...
        private bool isNet(VectorOfVectorOfPoint[] contours, PointF[] shape)
        {
